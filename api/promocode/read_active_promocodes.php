...
///read promo codes
// query promocodes
$stmt = $promocode->read_active_promocodes();
$num = $stmt->rowCount();
...
if($num>0){
    ...
    $promocodes_arr["active_promocodes"]=array();
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
        ...
        array_push($promocodes_arr["active_promocodes"], $promocode_item);
    }
